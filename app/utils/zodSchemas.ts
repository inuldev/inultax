...
export const invoiceSchema = z.object({
  ...
  invoiceItemDescription: z.string().min(1, "Deskripsi wajib diisi"),
  invoiceItemQuantity: z.number().min(1, "Kuantitas minimal 1"),
  invoiceItemRate: z.number().min(1, "Harga minimal 1"),
});
